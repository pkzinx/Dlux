...
describe('<Subtitle />', () => {
  it('Deve renderizar o componente <Subtitle /> em seu tamanho padrão', () => {
    ...
    renderWithTheme(
      <Subtitle>
        Em breve sua Barbearia favorita terá sua nova plataforma inaugurada!
      </Subtitle>
    );
    ...
    expect(subtitle).toHaveStyleRule('font-size', '5.0rem', {
  ...
  it('Deve renderizar o componente <Title /> em seu tamanho large', () => {
    ...
    //Assert
    expect(subtitle).toHaveStyle({ 'font-size': '3.0rem' });
    expect(subtitle).toHaveStyleRule('font-size', '6.0rem', {
      media: '(min-width: 768px)',
    });
  });
