...
const reviews: ReviewBoxProps[] = [
  ...
  },
  {
    ...
    stars: 5,
    feedback:
      'Melhor degrade da região, profissionais que amam oque fazem, estão de parabéns. Ótimo atendimento',
    name: 'Fernando',
    surname: 'bernardo',
  },
  {
    ...
    stars: 5,
    feedback:
      'Lugar top! Ótimo atendimento, o namorado entra feio e sai lindo. 👏🏽',
    name: 'Edilaine',
    surname: 'Viana',
  },
  {
