...
describe('<NavLinks />', () => {
  ...
  it('Verificar hover do menu do componente <NavLinks />', () => {
    ...
    expect(screen.getByText('Home')).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
    ...
    expect(screen.getByText(/Sobre/i)).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
    ...
    expect(screen.getByText(/Serviços/i)).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
    ...
    expect(screen.getByText(/Equipe/i)).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
    ...
    expect(screen.getByText(/Opinião/i)).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
    ...
    expect(screen.getByText(/FeedBack/i)).toHaveStyleRule('color', '#1affea', {
      modifier: ':hover',
    });
  });
});
